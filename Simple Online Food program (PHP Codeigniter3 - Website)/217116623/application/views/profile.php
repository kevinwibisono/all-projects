...
<body>
	...
	<div style="width: 800px; float: left;">
		<?php echo heading('&nbspProfil Pelanggan', 1, array('margin-top' => 10));?>
...
<b>Saldo E-Money : </b><?php echo $current_emoney.br(2);?>
		...
		<?php foreach($htrans as $h){?>
				...
				Pengiriman dari: <?php echo $h->alamat_dari.br(1);?>
				Menuju: <?php echo $h->alamat_tujuan.br(3);?>
				Status pesanan: <?php echo $h->status.br(3);?>
				<?php if($h->status == "Pengiriman"){
					  echo "Dikirim Oleh: ".$h->nama_driver.br(3);
				?>
				<img src="<?php echo base_url("assets/images/".$h->gambar_driver);?>"><br>
				<?php
					  echo "Tanggal Pengiriman: ".$h->tglpengiriman.br(3);
					  echo "Tanggal Sampai: -".br(3);
					  }
					  else if($h->status == "Sampai"){
					  echo "Dikirim Oleh: ".$h->nama_driver.br(3);
				?>
				<img src="<?php echo base_url("assets/images/".$h->gambar_driver);?>"><br>
				<?php
					  ...
					  echo "Dikirim Oleh: -".br(3);
					  echo "Tanggal Pengiriman: -".br(3);
				      echo "Tanggal Sampai: -".br(3);	
					  }
				?>
				<table>
				<?php foreach ($dtrans as $d){
					...
					<tr>
						<td><img src="<?php echo base_url('assets/images/'.$d->gambar);?>"></td>
