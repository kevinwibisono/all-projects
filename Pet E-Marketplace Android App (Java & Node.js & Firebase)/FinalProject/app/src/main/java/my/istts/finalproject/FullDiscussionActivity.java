...
import my.istts.finalproject.databinding.ActivityFullDiscussionBinding;
import my.istts.finalproject.viewmodels.FullDiscussionViewModel;
...
public class FullDiscussionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SwipeRefreshLayout swipeDiscuss = findViewById(R.id.swipeFullDiscuss);
