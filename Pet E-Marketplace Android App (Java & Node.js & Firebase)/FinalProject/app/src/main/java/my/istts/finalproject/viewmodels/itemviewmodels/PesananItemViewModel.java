...
public class PesananItemViewModel {
    ...
    public PesananItemViewModel(PesananJanjitemu pj) {
        ...
        akunDB.getAccByEmail(pj.getemail_penjual()).addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if(documentSnapshot.getData() != null){
                    storage.getPictureUrlFromName(pj.getemail_penjual()).addOnSuccessListener(new OnSuccessListener<Uri>() {
                        @Override
                        public void onSuccess(Uri uri) {
                            sellerPicture.setValue(uri.toString());
    ...
    private MutableLiveData<String> sellerPicture = new MutableLiveData<>("");
    ...
    public LiveData<String> getSellerPicture(){
